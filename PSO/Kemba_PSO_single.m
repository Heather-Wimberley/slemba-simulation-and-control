...
%     for j = kx
        ...
        problem.nVar = 9;  % Number of unknown/decision variable [x_oscf, y_oscf,x_oscb,y_oscb, y, tstb,tswf,tswb, dx]
        problem.VarMin = [-0.4,0.9,-0.4,0.9,0.4,simParams.tst*0.5,simParams.tst*2,simParams.tst,simParams.kx*2];  % Lower Bound of Decision variables
        problem.VarMax = [0.4,1.3,0.4,1.3,0.6,simParams.tst,simParams.tst*10,simParams.tst*10,simParams.kx*15];               % Upper Bound of Decision variables
        
        %% Parameters of PSO
        
        params.MaxIt = 50;        % Maximum Number of Iterations
        params.nPop = 18*3;          % Population Size (Swarm Size)
        ...
        toc
        % filename = "results/run" + count + ".mat";
        filename = "sol.mat";
